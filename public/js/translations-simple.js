...
if (typeof window.translations === 'undefined') {
    ...
    fr: {
        ...
        footer_credits: "© <a href='" + (window.APP_FRONT_URL || 'https://darkseagreen-mongoose-687346.hostingersite.com') + "/LANG_PREFIX/' target='_blank' rel='noopener noreferrer'>Hello Passenger</a> 2026. Tous droits réservés.",
        ...
        premium_pickup_hint: "Les dates et heures de prise en charge peuvent être modifiées et peuvent être différentes de celles de la consigne.",
        premium_restitution_hint: "Les dates et heures de restitution peuvent être modifiées et peuvent être différentes de celles de la consigne.",
        ...
        "forgot.status.loading": "Envoi en cours...",
        "forgot.status.success": "Un nouveau mot de passe a été envoyé à votre adresse email.",
        "forgot.status.error": "Erreur lors de l'envoi.",
        "forgot.status.networkError": "Impossible de contacter le serveur. Veuillez réessayer.",
    ...
    en: {
        ...
        premium_pickup_hint: "Pickup dates and times can be modified and may differ from those of the storage service.",
        premium_restitution_hint: "Return dates and times can be modified and may differ from those of the storage service.",
        ...
        footer_credits: "© <a href='" + (window.APP_FRONT_URL || 'https://darkseagreen-mongoose-687346.hostingersite.com') + "/LANG_PREFIX/' target='_blank' rel='noopener noreferrer'>Hello Passenger</a> 2026. All rights reserved.",
        ...
        "forgot.status.loading": "Sending...",
        "forgot.status.success": "A new password has been sent to your email address.",
        "forgot.status.error": "Error during sending.",
        "forgot.status.networkError": "Unable to contact server. Please try again.",
        "logout.title": "Logout",
