...
echo "Testing Monetico Void with Transaction ID: $transactionId\n";
echo "Base URL: $baseUrl\n\n";

$endpoints = [
    "/Charge/$transactionId/Void",
    "/PaymentMethod/$transactionId/Void",
    "/Transaction/Cancel",
...
foreach ($endpoints as $endpoint) {
    ...
    if (strpos($endpoint, 'Transaction') !== false) {
        $payload = ['transactionUuid' => $transactionId];
    }
