<?php
/**
 * Test endpoint commande/options - Avec vrai produit (corrigé)
 */
...
echo "=== TEST COMMANDE OPTIONS (Avec vrai produit - corrige) ===\n\n";
...
// Vérifier statut (peut etre 'statut' => 1 ou 'isSucceed' => true)
