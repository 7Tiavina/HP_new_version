...
@section('title', session('app_language', 'fr') === 'en' ? 'My Profile — Hello Passenger' : 'Mon Profil — Hello Passenger')
                ...
                <div class="border-t border-gray-200 pt-6 mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                <input type="text" id="adresse" name="adresse" value="{{ old('adresse', $client->adresse) }}" data-i18n-placeholder="placeholder_address" placeholder="Commencez à taper votre adresse..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500">
