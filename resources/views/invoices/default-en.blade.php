...
<head>
    ...
    <title>Invoice No. {{ $invoiceRef }}</title>
    <style>
        body {
...
<body>
    <div class="invoice-container">
        ...
        <table class="header-table">
            <tr>
                <td>
                    <!-- Logo temporarily removed for diagnostics -->
                </td>
                <td style="text-align: right;">
                    <h1>INVOICE</h1>
                    <p><strong>Invoice No.:</strong> {{ $invoiceRef }}</p>
        ...
        <table class="info-table">
            <tr>
                <td class="client-details">
                    <p style="font-weight: bold; margin-bottom: 10px;">Billed to:</p>
                ...
                <td class="company-details" style="text-align: right;">
                    ...
                    <p><strong>Tel:</strong> +33 (0)1 34 38 58 98</p>
                    <p><strong>E-Mail:</strong> contact@hellopassenger.com</p>
                    <p><strong>Website:</strong> hellopassenger.com</p>
                </td>
            </tr>
        </table>
        ...
        <div class="footer-section">
            ...
            <p><strong>Siret:</strong> 43919478800055 | <strong>VAT:</strong> FR08439194788</p>
        </div>
    </div>
</body>
</html>
