...
@section('content')
    ...
    <div class="container mx-auto max-w-5xl my-12 px-4">
        <div class="mb-6 flex justify-between items-center">
            <button onclick="history.back()" class="bg-yellow-custom text-gray-dark font-bold py-2 px-4 rounded-full btn-hover inline-flex items-center" data-i18n="payment_back_form">
