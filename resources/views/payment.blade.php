...
@section('content')
    ...
    <div class="container mx-auto max-w-5xl my-12 px-4">
        <div class="mb-6 flex justify-between items-center">
            <a href="{{ route('form-consigne') }}" class="bg-yellow-custom text-gray-dark font-bold py-2 px-4 rounded-full btn-hover inline-flex items-center no-underline" data-i18n="payment_back_form" style="text-decoration: none;">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        @elseif($hasPremium && !$premiumComplete)
                            <div class="p-4 bg-gray-100 rounded-md text-center text-gray-600">
                                <p class="text-sm" data-i18n="payment_missing_premium_text">Veuillez compléter vos informations pour activer le paiement.</p>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (clientProfileForm) {
                ...
                clientProfileForm.addEventListener('submit', async (e) => {
                    ...
                    // Validate client profile fields for BOTH guest and connected users
                    console.log('[MODAL SUBMIT] Running client profile validation...');
                    if (!validateGuestForm()) {
                        console.log('[MODAL SUBMIT] Client profile validation failed. Submission stopped.');
                        isSubmitting = false;
                        if (submitBtn) {
                    ...
                    console.log('[MODAL SUBMIT] Client profile validation passed.');
